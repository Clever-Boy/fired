...
void fired::MapGenerator::genBuilding() {
	genBuildingLandscape(0, sizeX - 1, 40);
	genBuildingDecors();
	genBuildingPlatforms();
	genBuildingCollectors();
	genBuildingPlayer();
}
...
/***********************************************************************
     * MapGenerator
     * genBuildingLandscape

***********************************************************************/
void fired::MapGenerator::genBuildingLandscape(int areaStart, int areaEnd, int horizon) {
	setBrush("concrete");
...
***********************************************************************/
void fired::MapGenerator::genBuildingDecors() {
...
***********************************************************************/
void fired::MapGenerator::genBuildingPlatforms() {
...
***********************************************************************/
void fired::MapGenerator::genBuildingCollectors() {
