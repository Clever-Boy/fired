...
void fired::MapGenerator::genCitySpawns() {
	addSpawn(141, 34, 16,  5, mstCritter           );
	addSpawn(  3, 34, 16,  5, mstCritter           );
	addSpawn( 55, 30, 19,  5, mstCreature | mstBoss);
	addSpawn( 35, 49, 16, 23, mstCreature          );
	addSpawn(  4, 61, 32,  5, mstCreature          );
	addSpawn( 35, 80,  8,  5, mstCreature          );
	addSpawn( 42, 61, 45,  5, mstCreature | mstBoss);
	addSpawn(140, 44, 20, 12, mstCreature | mstBoss);
